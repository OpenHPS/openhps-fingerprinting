...
describe('dataset', () => {
    describe('ujiindoorloc', function () {
        ...
        const onlineSink: CallbackSinkNode<any> = new CallbackSinkNode();
        ...
        before(function (done) {
            ...
            ModelBuilder.create()
                ...
                .from(
                    new CSVDataSource('test/data/UJIIndoorLoc/trainingData.csv', (row) => {
                        ...
                        for (let i = 1; i <= 520; i++) {
                            ...
                            if (rssi !== 100) phone.addRelativePosition(new RelativeRSSI(accessPoint, rssi));
                        }
                ...
                .then((m) => {
                    ...
                    return ModelBuilder.create()
                        ...
                        .from(
                            new CSVDataSource(
                                'test/data/UJIIndoorLoc/validationData.csv',
                                (row) => {
                                    ...
                                    for (let i = 1; i <= 520; i++) {
                                        ...
                                        const rssi = parseInt(row[accessPoint]);
                                        if (rssi !== 100)
                                            phone.addRelativePosition(new RelativeRSSI(accessPoint, rssi));
                                    }
